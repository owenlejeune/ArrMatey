...
class SeerrClientImpl(
    ...
    override suspend fun testConnection(): NetworkResult<Unit> = get(instance.type.testEndpoint)

    override suspend fun getUserInfo(): NetworkResult<SeerrUser> = get("auth/me")

    override suspend fun getUsers(
        take: Int,
        skip: Int,
    ): NetworkResult<UserResponse> = get("user", mapOf("take" to take, "skip" to skip))

    override suspend fun getTrending(page: Int): NetworkResult<DiscoverResponse> = get("discover/trending", mapOf("page" to page))

    override suspend fun getDiscoverMovies(page: Int): NetworkResult<DiscoverResponse> = get("discover/movies", mapOf("page" to page))

    override suspend fun getUpcomingMovies(
        page: Int,
        today: String,
    ): NetworkResult<DiscoverResponse> = get("discover/movies", mapOf("page" to page, "primaryReleaseDateGte" to today))

    override suspend fun getDiscoverTv(page: Int): NetworkResult<DiscoverResponse> = get("discover/tv", mapOf("page" to page))

    override suspend fun getUpcomingTv(
        page: Int,
        today: String,
    ): NetworkResult<DiscoverResponse> = get("discover/tv", mapOf("page" to page, "firstAirDateGte" to today))

    override suspend fun search(
        query: String,
        page: Int,
    ): NetworkResult<DiscoverResponse> = get("search", mapOf("query" to query.encodeURLQueryComponent(), "page" to page))
    ...
    override suspend fun getPersonCredits(personId: Long): NetworkResult<PersonCredits> = get("person/$personId/combined_credits")
    ...
    override suspend fun deleteMediaFile(
        mediaId: Long,
        is4k: Boolean,
    ): NetworkResult<Unit> = delete("media/$mediaId/file", mapOf("is4k" to is4k))

    override suspend fun clearMediaData(mediaId: Long): NetworkResult<Unit> = delete("media/$mediaId")
    ...
    override suspend fun getTvRatings(mediaId: Long): NetworkResult<RottenTomatoesRating> = get("tv/$mediaId/ratings")

    override suspend fun getSeasonDetails(
        mediaId: Long,
        seasonNumber: Int,
    ): NetworkResult<Season> = get("tv/$mediaId/season/$seasonNumber")

    override suspend fun getRadarrServices(): NetworkResult<List<Service>> = get("service/radarr")

    override suspend fun getSonarrServices(): NetworkResult<List<Service>> = get("service/sonarr")

    override suspend fun getRadarrDetails(id: Long): NetworkResult<ServiceDetails> = get("service/radarr/$id")

    override suspend fun getSonarrDetails(id: Long): NetworkResult<ServiceDetails> = get("service/sonarr/$id")
    ...
    override suspend fun closeIssue(issueId: Long): NetworkResult<Unit> = delete("issue/$issueId")
