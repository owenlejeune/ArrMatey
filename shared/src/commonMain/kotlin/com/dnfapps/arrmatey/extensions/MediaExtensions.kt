...
fun ArrMedia.getUpcomingDateString(
    ...
    return when (this) {
        is ArrSeries -> if (status == MediaStatus.Continuing) {
            val formattedNextAiring = nextAiring?.format(
