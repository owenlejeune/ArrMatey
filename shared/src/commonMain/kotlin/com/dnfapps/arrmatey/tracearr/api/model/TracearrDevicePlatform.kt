...
enum class TracearrDevicePlatform {
    ...
    companion object {
        fun fromSession(
            ...
            val rawTokens = listOfNotNull(platform, product, device)
                .joinToString(" ")
                .lowercase()
            ...
            return when {
                ...
                rawTokens.containsAny(
                    "tv", "appletv", "apple tv", "roku", "firetv",
                    "fire tv", "chromecast", "cast", "tizen", "webos",
                    "shield", "bravia"
                ) -> TV
                ...
                rawTokens.containsAny(
                    "iphone", "android", "mobile", "phone", "ios"
                ) -> PHONE

                // Desktop / Web browsers
                rawTokens.containsAny(
                    "windows", "mac", "macos", "osx", "linux",
                    "chrome", "firefox", "safari", "edge", "opera", "web"
                ) -> DESKTOP
