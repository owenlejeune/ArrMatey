...
abstract class BaseArrClient(
    ...
    override suspend fun getCustomFilters(): NetworkResult<List<CustomFilter>> = get("customFilter")

    override suspend fun command(payload: CommandPayload): NetworkResult<Any> = post<CommandPayload, CommandResponse>("command", payload)
    ...
    override suspend fun getDiskSpace(): NetworkResult<List<ArrDiskSpace>> = get("diskspace")

    override suspend fun getHealth(): NetworkResult<List<ArrHealth>> = get("health")
