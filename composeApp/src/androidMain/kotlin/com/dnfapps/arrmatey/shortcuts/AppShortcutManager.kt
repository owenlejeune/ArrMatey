...
class AppShortcutManager(
    ...
    companion object {
        const val ACTION_OPEN_LIBRARY = NotificationConstants.ACTION_OPEN_LIBRARY
        const val ACTION_OPEN_SEARCH = NotificationConstants.ACTION_OPEN_SEARCH
        const val ACTION_OPEN_DOWNLOADS = NotificationConstants.ACTION_OPEN_DOWNLOADS
        const val ACTION_OPEN_ACTIVITY = NotificationConstants.ACTION_OPEN_ACTIVITY
        const val ACTION_OPEN_SCHEDULE = NotificationConstants.ACTION_OPEN_SCHEDULE
        const val ACTION_OPEN_REQUESTS = NotificationConstants.ACTION_OPEN_REQUESTS
