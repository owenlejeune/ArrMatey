...
sealed interface SettingsScreen : NavKey {
    ...
    data class AddInstance(
        val type: InstanceType = InstanceType.Sonarr,
    ) : SettingsScreen
    ...
    data class EditDownloadClient(
        val id: Long,
    ) : SettingsScreen

    data object AddCustomWebpage : SettingsScreen

    data class EditCustomWebpage(
        val id: Long,
    ) : SettingsScreen
}
...
sealed interface TracearrScreen : NavKey {
    ...
    data object Violations : TracearrScreen

    data object Activity : TracearrScreen
}
